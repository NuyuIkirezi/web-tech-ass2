public package com.afanyu.servlets;
...
// Remove @WebServlet annotation if using web.xml mapping
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        // Navigation buttons
        out.println("            <div class='mt-8 flex gap-4 justify-center'>");
        ...
        out.println("                </a>");
        out.println("                <a href='index.html' class='inline-block bg-gray-600 text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl hover:bg-gray-700 transform transition-all duration-200 hover:scale-105'>");
        out.println("                    Home");
        out.println("                </a>");
        out.println("            </div>");
